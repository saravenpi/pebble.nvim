    ...
    if opts.auto_setup_keymaps ~= false then
        vim.api.nvim_create_autocmd("FileType", {
            ...
            callback = function()
                ...
                vim.keymap.set({"n", "i"}, "<C-Space>", M.toggle_checklist, vim.tbl_extend("force", buf_opts, { desc = "Toggle markdown checklist" }))
                vim.keymap.set({"n", "i"}, "<C-@>", M.toggle_checklist, vim.tbl_extend("force", buf_opts, { desc = "Toggle markdown checklist" }))
